package io.github.fatimazza.mycomposeapp.data.reply.local

import io.github.fatimazza.mycomposeapp.R
import io.github.fatimazza.mycomposeapp.data.reply.Account
...
object LocalAccountsDataProvider {
    val defaultAccount = Account(-1, -1, -1, -1, R.drawable.reply_avatar_0)
    ...
    val userAccount =
        Account(
            ...
            avatar = R.drawable.reply_avatar_1
        )
    ...
    private val allUserContactAccounts = listOf(
        Account(
            ...
            avatar = R.drawable.reply_avatar_0
        ),
        Account(
            id = 5L,
            ...
            avatar = R.drawable.reply_avatar_5
        ),
        Account(
            id = 6L,
            ...
            avatar = R.drawable.reply_avatar_2
        ),
        Account(
            id = 7L,
            ...
            avatar = R.drawable.reply_avatar_7
        ),
        Account(
            id = 8L,
        ...
        Account(
            ...
            avatar = R.drawable.reply_avatar_express
        ),
        Account(
            id = 10L,
        ...
        Account(
            ...
            avatar = R.drawable.reply_avatar_6
        ),
        Account(
            id = 13L,
            ...
            avatar = R.drawable.reply_avatar_4
        )
    )
